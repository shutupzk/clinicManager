...
class AppointmentAddScreen extends Component {
  constructor(props) {
    super(props)
    this.state = {
      pageType: 1,
...
export default connect(mapStateToProps, { addAppointment, queryScheduleDepartments, queryScheduleDoctors, getPatientByKeyword, querySchedules })(AppointmentAddScreen)
