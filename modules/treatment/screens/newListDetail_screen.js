    ...
    return(
      <div>
       <div className={'childTopBar'}>
          ...
          <span className={this.state.pageType==1?'sel':''} onClick={() => this.changeContent({type:1})} >基本信息</span>
          <span className={this.state.pageType==2?'sel':''} onClick={() => this.changeContent({type:2})}>会员信息</span>
          <span className={this.state.pageType==3?'sel':''} onClick={() => this.changeContent({type:3})}>就诊信息</span>
          <span className={this.state.pageType==4?'sel':''} onClick={() => this.changeContent({type:4})}>健康档案</span>
          <span className={this.state.pageType==5?'sel':''} onClick={() => this.changeContent({type:5})}>收费信息</span>
          <span className={this.state.pageType==6?'sel':''} onClick={() => this.changeContent({type:6})}>积分信息</span>
          <span className={this.state.pageType==7?'sel':''} onClick={() => this.changeContent({type:7})}>预约登记</span>
        </div>
        {this.showBaseInfo()}
      </div>
    )
