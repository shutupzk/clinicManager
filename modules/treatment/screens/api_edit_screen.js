...
class APIEditScreen extends Component {
  constructor (props) {
    super(props)
    this.state = {
  ...
  componentDidMount () {
    ...
    const { apiName, description, input, output } = this.getData()
    this.setState({ apiName, description, input: [readJsonKey('input', input)], output: [readJsonKey('output', output)] })
  }
...
export default connect(mapStateToProps, { createBaseApi })(APIEditScreen)
