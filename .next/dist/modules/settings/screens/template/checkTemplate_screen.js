...
var CheckTemplateScreen = function (_Component) {
  (0, _inherits3.default)(CheckTemplateScreen, _Component);

  function CheckTemplateScreen(props) {
    (0, _classCallCheck3.default)(this, CheckTemplateScreen);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CheckTemplateScreen.__proto__ || (0, _getPrototypeOf2.default)(CheckTemplateScreen)).call(this, props));

    _this.state = {};
    return _this;
  }

  (0, _createClass3.default)(CheckTemplateScreen, [{
