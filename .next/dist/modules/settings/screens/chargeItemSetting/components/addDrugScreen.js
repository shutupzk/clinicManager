...
var AddDrugScreen = function (_Component) {
  ...
  (0, _createClass3.default)(AddDrugScreen, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', { className: 'contentCenter' }, this.renderSearchBlank(), this.renderBaseInfoBlank(), this.renderFeeInfoBlank(), this.renderUsageInfoBlank(), this.renderAlertSettingBlank(), this.renderOtherInfoBlank(), _react2.default.createElement('div', { className: 'bottomBtn' }, _react2.default.createElement('div', null, _react2.default.createElement('button', null, '\u53D6\u6D88'), _react2.default.createElement('button', { onClick: function onClick() {
    ...
    value: function renderSearchBlank() {
      return _react2.default.createElement('div', { className: 'commonBlank searchBlank' }, _react2.default.createElement('span', null, '\u897F/\u6210\u836F\u54C1\u4FE1\u606F'), _react2.default.createElement('div', null, _react2.default.createElement('input', { type: 'text', placeholder: '国药准字license_no' }), _react2.default.createElement('input', { style: { marginLeft: '10px' }, type: 'text', placeholder: '药品条形码' }), _react2.default.createElement('button', null, '\u67E5\u8BE2')), this.style());
    }
    // 剂型筛选
    ...
    value: function renderBaseInfoBlank() {
      ...
      })), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u751F\u4EA7\u5382\u5BB6'), _react2.default.createElement('input', {
        type: 'text',
      ...
      })), this.state.dose_form_idFailed || drugInfo.dose_form_id === '' || !drugInfo.dose_form_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u5546\u54C1\u540D'), _react2.default.createElement('input', {
        type: 'text',
      ...
      })), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u836F\u54C1\u5206\u7C7B', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement(_components.Select, {
        placeholder: '请选择',
        height: 32,
      ...
      })), this.state.drug_class_idFailed || drugInfo.drug_class_id === '' || !drugInfo.drug_class_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u62FC\u97F3\u7801'), _react2.default.createElement('input', {
        type: 'text',
        placeholder: 'py_code',
      ...
      })), this.state.mini_unit_idFailed || drugInfo.mini_unit_id === '' || !drugInfo.mini_unit_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u5236\u5242\u6570\u91CF'), _react2.default.createElement('input', {
        type: 'number',
      ...
      })), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u5236\u5242\u6570\u91CF\u5355\u4F4D', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement(_components.Select, {
        placeholder: '请选择',
        height: 32,
        options: this.getMiniUnitOptions(),
      ...
      })), this.state.dose_count_unit_idFailed || drugInfo.dose_count_unit_id === '' || !drugInfo.dose_count_unit_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u5305\u88C5\u5355\u4F4D', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement(_components.Select, {
        placeholder: '请选择',
        height: 32,
        options: this.getMiniUnitOptions(),
      ...
      })), this.state.packing_unit_idFailed || drugInfo.packing_unit_id === '' || !drugInfo.packing_unit_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''))));
    }
    // 费用信息
    ...
    value: function renderFeeInfoBlank() {
      ...
      }), '\u5426'))), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u662F\u5426\u5141\u8BB8\u62C6\u96F6', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement('label', null, _react2.default.createElement('input', {
        type: 'radio',
        name: 'removeZero',
      ...
      }), '\u5426'))), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u62C6\u96F6\u552E\u4EF7', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement('input', {
        type: 'text',
      ...
      }), '\u5143'), drugInfo.is_bulk_sales && (this.state.bulk_sales_priceFailed || drugInfo.bulk_sales_price === '' || !drugInfo.bulk_sales_price) ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u53D6\u836F\u5730\u70B9', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement('label', null, _react2.default.createElement('input', {
        type: 'radio',
        name: 'fetch_address',
      ...
      }), '\u4EE3\u8D2D')), this.state.fetch_addressFailed ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''))), this.style());
    }
    // 默认用法用量
    ...
    value: function renderUsageInfoBlank() {
      ...
      return _react2.default.createElement('div', { className: 'commonBlank baseInfoBlank' }, _react2.default.createElement('span', null, '\u9ED8\u8BA4\u7528\u6CD5\u7528\u91CF'), _react2.default.createElement('div', null, _react2.default.createElement('ul', null, _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u5355\u6B21\u5242\u91CF'), _react2.default.createElement('input', {
        type: 'number',
      ...
      })), this.state.once_dose_unit_idFailed || drugInfo.once_dose_unit_id === '' || !drugInfo.once_dose_unit_id ? _react2.default.createElement('div', { style: { color: 'red', fontSize: '12px' } }, '\u6B64\u4E3A\u5FC5\u586B\u9879') : ''), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u9ED8\u8BA4\u7528\u6CD5', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement(_components.Select, {
        placeholder: '请选择',
        height: 32,
    ...
    value: function renderAlertSettingBlank() {
      ...
      return _react2.default.createElement('div', { className: 'commonBlank baseInfoBlank' }, _react2.default.createElement('span', null, '\u9884\u8B66\u8BBE\u7F6E'), _react2.default.createElement('div', null, _react2.default.createElement('ul', null, _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u6548\u671F\u9884\u8B66', _react2.default.createElement('b', { style: { color: 'red' } }, '*')), _react2.default.createElement('div', null, _react2.default.createElement('input', {
        type: 'number',
        placeholder: 'eff_day',
    ...
    value: function renderOtherInfoBlank() {
      ...
      return _react2.default.createElement('div', { className: 'commonBlank baseInfoBlank' }, _react2.default.createElement('span', null, '\u5176\u4ED6\u4FE1\u606F'), _react2.default.createElement('div', null, _react2.default.createElement('ul', null, _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u82F1\u6587\u540D\u79F0'), _react2.default.createElement('input', {
        type: 'text',
      ...
      })), _react2.default.createElement('li', null, _react2.default.createElement('label', null, '\u4E0A\u836F\u7F16\u7801'), _react2.default.createElement('input', {
        type: 'text',
        placeholder: 'sy_code',
