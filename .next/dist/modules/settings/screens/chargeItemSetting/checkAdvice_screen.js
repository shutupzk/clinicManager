...
var CheckAdviceScreen = function (_Component) {
  (0, _inherits3.default)(CheckAdviceScreen, _Component);

  function CheckAdviceScreen(props) {
    (0, _classCallCheck3.default)(this, CheckAdviceScreen);

    var _this = (0, _possibleConstructorReturn3.default)(this, (CheckAdviceScreen.__proto__ || (0, _getPrototypeOf2.default)(CheckAdviceScreen)).call(this, props));

    _this.state = {};
    return _this;
  }

  (0, _createClass3.default)(CheckAdviceScreen, [{
